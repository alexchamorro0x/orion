      ...
      <section className="container flex text-slate-300 mx-auto">
        <div className="legal">
          ...
          <div className="blog-post-text">
            <p>
              Welcome to Orion Digital Consulting (the “Platform”). We are
              committed to protecting and respecting your privacy. This Privacy
              Policy covers the experience we provide for users age 13 and over
              on our Platform. Users under the age of 13 are not permitted to
              upload information to the Platform (see “Children” below).
            </p>
            <p>
              Capitalized terms that are not defined in this policy have the
              meaning given to them in the{" "}
              <Link href="/terms" onClick={ResetLocation}>
                <strong>
          ...
          <div className="blog-post-text">
            <p>
              ...
              Platform and, if you grant us access, information from your phone
              book on your mobile device. More information about the categories
              and sources of information is provided below.
            </p>
            <p className="bold-text">Information you choose to provide</p>
            <div>
              <p>
                For certain activities, such as when you register, upload
                content to the Platform, or contact us directly, you may provide
              ...
              <ul className="ml-8 list-outside list-disc mb-4">
                ...
                <li>
                  Profile information, such as name, social media account
                  information, and profile image
                </li>
                <li>
                  User-generated content, including comments, photographs, live
                  streams, audio recordings, videos, and virtual item videos
                  that you choose to create with or upload to the Platform
                  (“User Content”). We may collect User Content through
                  pre-loading at the time of creation, import, or upload,
                  regardless of whether you choose to save or upload that User
                  Content, in order to provide other personalized
                  recommendations.
                </li>
                <li>
                  Content, including text, images, and video, found in your
                  device’s clipboard, with your permission. For example, if you
                  choose to initiate content sharing with a third-party
                  platform, or choose to paste content from the clipboard into
                  the ODC, we access this information stored in your clipboard
                  in order to fulfill your request.
                </li>
                <li>
                  Payment information, including payment card numbers or other
                  third-party payment information (such as PayPal) where
                ...
                <li>
                  ...
                  we will access and collect the names and phone numbers and
                  match that information against existing users of the Platform.
                  If you choose to find other users through your social network
                  contacts, we will collect your public profile information as
                  well as names and profiles of your social network contacts
                </li>
                <li>Your opt-in choices and communication preferences</li>
                <li>
                  Information to verify an account such as proof of identity or
                  age
                </li>
            ...
            <p>
              <strong>Social Media and Login Services.</strong> If you choose to
              link or sign up using a third-party social network or login
              service (such as Facebook, Twitter, Instagram, or Google), we may
              collect information from these services, including your contact
              lists for these services and information relating to your use of
              the Platform in relation to these services. If you link your ODC
              account to another service, we may receive information about your
              use of that service.
            </p>
            <p>
              <strong>Third-Party Services.</strong> We may collect information
              about you from third-party services, such as advertising partners,
              data providers, and analytics providers.
            </p>
            <p>
              <strong>Other Users of the Platform.</strong> Sometimes other
              users of the Platform may provide us information about you,
              including through customer service inquiries.
            </p>
            <p>
              <strong>Other Sources.</strong> We may collect information about
              you from other publicly available sources.
            </p>
            <p className="bold-text">Information we collect automatically</p>
            <p>
              We automatically collect certain information from you when you use
              the Platform, including internet or other network activity
              information such as your IP address, geolocation-related data (as
              described below), unique device identifiers, browsing and search
              history (including content you have viewed in the Platform), and
              Cookies (as defined below).
            </p>
            <p className="bold-text">Usage Information</p>
            <p>
            ...
            <p className="bold-text">Device Information</p>
            <p>
              ...
              types, battery state, audio settings and connected audio devices.
              Where you log-in from multiple devices, we will be able to use
              your profile information to identify your activity across devices.
            </p>
            <p className="bold-text">Location data</p>
            <p>
            ...
            <p className="bold-text">Image and Audio Information</p>
            <p>
              We may collect information about the images and audio that are a
              part of your User Content, such as identifying the objects and
              scenery that appear, the existence and location within an image of
              face and body features and attributes, the nature of the audio,
              and the text of the words spoken in your User Content. We may
              collect this information to enable content moderation, for
              demographic classification, for content and ad recommendations,
              and for other non-personally-identifying operations. We may
              collect biometric identifiers and biometric information as defined
              under US laws, such as faceprints and voiceprints, from your User
              Content. Where required by law, we will seek any required
              permissions from you prior to any such collection.
            </p>
            <p className="bold-text">Metadata</p>
            <p>
              ...
              collected, or modified and how that content is formatted. It also
              includes information, such as your account name, that enables
              other users to trace back the User Content to your user account.
              Additionally, metadata includes data that you choose to provide
              with your User Content, e.g. any hashtags used to mark keywords to
            ...
            <p>
              ...
              analyze which web pages and advertisements you click on and how
              you use the Platform, enhance your experience using the Platform,
              improve the Platform, provide you with advertising on the Platform
              and elsewhere across your devices, and measure the effectiveness
              of advertisements. Cookies enable the Platform to provide certain
            ...
            <p>
              ...
              Platform across all your devices, using your email or other log-in
              or device information. Our service providers and business partners
              may use this information to display advertisements on our Platform
              and elsewhere online and across your devices tailored to your
          ...
          <div className="blog-post-text">
            <p>
              ...
              functionalities, and to fulfill and enforce our Terms of Service.
              We may also use your information to, among other things, show you
              suggestions, promote the Platform, and customize your ad
              experience.
            </p>
            <div>
              ...
              <ul className="ml-8 list-outside list-disc mb-4">
                <li>
                  ...
                  research, statistical, and survey purposes and to solicit your
                  feedback
                </li>
                <li>
                  To customize the content you see when you use the Platform.
                  For example, we may provide you with services based on the
                  country settings you have chosen or show you content that is
                  similar to content that you like or interacted with
                </li>
                <li>
                ...
                <li>
                  To measure and understand the effectiveness of the advertising
                ...
                <li>
                  ...
                  permit you and other users to connect with each other through
                  the Platform and for you and other users to share, download,
                  and otherwise interact with User Content posted through the
                  Platform
                </li>
                <li>
                ...
                <li>
                  To prove your identity in order to use certain features, such
                  as verified accounts, or when you apply for a Pro Account,
                  ensure that you are old enough to use the Platform (as
                  required by law), or in other instances where verification may
                  be required
                </li>
                <li>
                ...
                <li>As otherwise allowed by law.</li>
              </ul>
            </div>
          </div>
          <Heading as="h3">How we share your information</Heading>
          <div className="blog-post-text">
            <p>
              We are committed to maintaining your trust. We want you to
              understand when and with whom we may share the information we
              collect for business purposes.
            </p>
            <p className="bold-text">Service Providers and Business Partners</p>
            <div>
              <p>
                ...
                advertising, analytics, measurement, data storage and hosting,
                disaster recovery, search engine optimization, marketing, and
                data processing. These service providers and business partners
                may include:
              </p>
              <ul className="ml-8 list-outside list-disc mb-4">
                <li>
                  Businesses, and individuals identified under Party 1 and Party
                  2 in any element of a ODC (ODC, Alternative or Review) and any
                  other parties as may further our business interests (including
                  but not limited to paying customers for ODC data, prospective
                  customers and the media).
                </li>
                <li>
                  Payment processors and transaction fulfillment providers, who
                  may receive the information you choose to provide, the
                  information we obtain from other sources, and the information
                  we collect automatically but who do not receive your message
                  data.
                </li>
                <li>
                  Customer and technical support providers, who may receive the
                  information you choose to provide, the information we obtain
                  from other sources, and the information we collect
                  automatically.
                </li>
                <li>
                  Research providers, who may receive the information you choose
                  to provide, the information we obtain from other sources, and
                  the information we collect automatically but would not receive
                ...
                <li>
                  ...
                  automatically but would not receive your payment information
                  or message data.
                </li>
              </ul>
            </div>
            <p className="bold-text">Within Our Corporate Group</p>
            <p>
            ...
            <p>
              We may share all of the information we collect in connection with
              a substantial corporate transaction, such as the sale of a
              website, a merger, consolidation, asset sales, or in the unlikely
              event of bankruptcy.
            </p>
            <p className="bold-text">For Legal Reasons</p>
            <p>
              ...
              the rights, interests, safety, and security of Orion Digital
              Constuling Inc., the Platform, our affiliates, users, or the
              public. We may also share any of the information we collect to
              enforce any terms applicable to the Platform, to exercise or
              defend any legal claims, and comply with any applicable law.
            </p>
            <p className="bold-text">With Your Consent</p>
            <p>
            ...
            <p>
              ...
              Twitter, to login to the Platform or to share information about
              your usage on the Platform with others, these third-party services
              may be able to collect information about you, including
              information about your activity on the Platform, and they may
              notify your connections on the third-party services about your use
              of the Platform, in accordance with their privacy policies. If you
              ...
              able to obtain your account information and other information you
              choose to provide.
            </p>
            <p>
          ...
          <div className="blog-post-text">
            <p>
              ...
              authority to submit requests to exercise rights on your behalf. We
              will respond to your request consistent with applicable law and
              ...
              account or to provide information necessary to verify your
          ...
          <div className="blog-post-text">
            <ul className="ml-8 list-outside list-disc mb-4">
              ...
              <li>
                Depending on the version of the Platform you are using, you may
                be able to decide whether you see certain types of
                interest-based advertising on the Platform by visiting your
                in-app settings.
              </li>
              <li>
              ...
              <li>
                ...
                control whether we can use your mobile advertising identifier
                for advertising through settings on your Apple and Android
                devices.
              </li>
              <li>
              ...
              <li>
                If you previously chose to share precise location information,
                you can prevent your device from sharing precise location
                information (e.g. GPS location information) with the Platform at
          ...
          <Heading as="h3">Security and Storage</Heading>
          <div className="blog-post-text">
            <p>
              ...
              can be guaranteed to be 100 percent secure. Please note that
              information collected by third parties may not have the same
              security protections as information you submit to us, and we are
              not responsible for protecting the security of such information.
            </p>
            <p>
              ODC may transmit your data to its servers or data centers outside
              of the United States for storage and/or processing. Third parties
              with whom ODC may share your data as described herein may be
              located outside of the United States.
            </p>
          </div>
          <Heading as="h3">Device Fingerprinting</Heading>
          <div className="blog-post-text">
            <p>
              We share your personal data with third party payment service
              providers, who may use device fingerprinting technology to collect
              information about your device for fraud prevention, identity
              check, or security reasons.
            </p>
            <p>
              A device fingerprint refers to a collection of attributes about a
              device that enable the device to be recognised or uniquely
          ...
          <div className="blog-post-text">
            <p>
              ...
              important to us. The Platform is not directed at children under
              the age of 13. If we become aware that personal information has
              been collected on the Platform from a person under the age of 13
              ...
              <Link href="/contact" onClick={ResetLocation}>
                <strong>
                  <em>Contact Us</em>
                </strong>
              </Link>{" "}
          ...
          <Heading as="h3">Other Rights</Heading>
          <div className="blog-post-text">
            <p className="bold-text">
            ...
            <p>
              ...
              categories of customer information, as well as the names and
            ...
            <p>
              ...
              do not accept California Removal Requests via postal mail,
              telephone, or facsimile. We are not responsible for notices that
              are not labeled or sent properly, and we may not be able to
              ...
              removal of the material. For example, materials that you have
          ...
          <div className="blog-post-text">
            <p>
              ...
              “Last Updated” date at the top of this policy and posting the new
              Privacy Policy and providing any other notice required by
          ...
          <div className="blog-post-text">
            ...
            <p>
              ...
              Policy. It describes Our policies and procedures on the
            ...
            <p>
              ...
              <Link
                href="https://www.termsfeed.com/blog/sample-ccpa-privacy-policy-template/"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <Heading as="h3">Interpretation and Definitions</Heading>
          <div className="blog-post-text">
            <div>
              <p className="bold-text">Interpretation</p>
              <p>
            ...
            <div>
              <p className="bold-text">Definitions</p>
              <div>
                ...
                <ul className="ml-8 list-outside list-disc mb-4">
                  ...
                  <li>
                    ...
                    the CCPA (California Consumer Privacy Act), refers to the
                    Company as the legal entity that collects Consumers&apos;
                    personal information and determines the purposes and means
                    of the processing of Consumers&apos; personal information,
                    or on behalf of which such information is collected and that
                  ...
                  <li>
                    ...
                    &quot;Our&quot; in this Agreement) refers to ODC.
                  </li>
                  <li>
                    <strong>&quot;Country&quot;</strong> refers to the United
                    States of America.
                  </li>
                  <li>
                    <strong>&quot;Consumer&quot;</strong>, for the purpose of
                    the CCPA (California Consumer Privacy Act), means a natural
                    person who is a California resident. A resident, as defined
                    in the law, includes (1) every individual who is in the USA
                    for other than a temporary or transitory purpose, and (2)
                    every individual who is domiciled in the USA who is outside
                    the USA for a temporary or transitory purpose.
                  </li>
                  <li>
                    <strong>&quot;Cookies&quot;</strong> are small files that
                    are placed on Your computer, mobile device or any other
                    device by a website, containing the details of Your browsing
                    history on that website among its many uses.
                  </li>
                  <li>
                    <strong>&quot;Data Controller&quot;</strong>, for the
                    purposes of the GDPR (General Data Protection Regulation),
                  ...
                  <li>
                    ...
                    that has been promoted by US regulatory authorities, in
          ...
          <Heading as="h3">CCPA Privacy</Heading>
          <div className="blog-post-text">
            <p>
            ...
            <ul className="ml-8 list-outside list-disc mb-4">
              ...
              <li>
                ...
                <br />
                Collected: No, unless provided by You in voluntarily uploaded
                user content that You authored.
              </li>
              <li>
            ...
            <ul className="ml-8 list-outside list-disc mb-4">
              ...
              <li>
                ...
                <ul className="ml-8 list-outside list-[square] mt-1 mb-4">
                  <li>
            ...
            <p className="bold-text">Sources of Personal Information</p>
            <div>
              <p>
            ...
            <div>
              ...
              <ul className="ml-8 list-outside list-disc mb-4">
                <li>
                  To operate and improve our Service and provide You with our
                  Service.
                </li>
                <li>
            ...
            <p className="bold-text">Sale of Personal Information</p>
            <p>
            ...
            <p>
              <u>No Sales:</u> We have not in the last twelve (12) months sold
              personal information about You.
            </p>
            <div>
              <p>
                In the future, We may sell the following categories of personal
                information:
              </p>
              <ul className="ml-8 list-outside list-disc mb-4">
                <li>Category A: Identifiers</li>
            ...
            <p className="bold-text">Share of Personal Information</p>
            <div>
              <p>
              ...
              <ul className="ml-8 list-outside list-disc mb-4">
                ...
                <li>
                  Party 1 and Party 2 as identified in ODCs that you post, and
                  other parties who have an interest in the data in furtherance
          ...
          <Heading as="h3">Your Rights under the CCPA</Heading>
          <div className="blog-post-text">
            <p>
            ...
            <ul className="ml-8 list-outside list-disc mb-4">
              ...
              <li>
                ...
                share of personal information. Once We receive and confirm Your
                request, We will disclose to You:
                <ul className="ml-8 list-outside list-[square] mt-1">
                  <li>
                  ...
                  <li>
                    ...
                    disclose to You:
                    <ul className="ml-8 list-outside list-disc mt-1">
                      <li>
              ...
              <li>
                ...
                information. To submit an opt-out request please email Us at
              </li>
              <li>
          ...
          <Heading as="h3">Exercising Your CCPA Data Protection Rights</Heading>
          <div className="blog-post-text">
            <p>
          ...
          <Heading as="h3">Do Not Sell My Personal Information</Heading>
          <div className="blog-post-text">
            <p>
          ...
          <Heading as="h3">Mobile Devices</Heading>
          <div className="blog-post-text">
            <p>
          ...
          <Heading as="h3">Links to Other Websites</Heading>
          <div className="blog-post-text">
            <p>
          ...
          <Heading as="h2">International Users Outside the USA</Heading>
          <div className="blog-post-text">
            <strong>Introduction</strong>
            <ol className="ml-8 list-outside list-decimal mt-2">
              <li>
              ...
              <li>
                This notice applies where we are acting as a data controller
                with respect to the personal data of such persons; in other
                words, where we determine the purposes and means of the
                processing of that personal data.
              </li>
              <li>
                The purpose of our website is to improve the world and enhance
                democracy. If You create an account via any of the “sign-in”
                links, any information, personal or otherwise, that You provide
              ...
              <li>
                By using our Platform, You acknowledge and understand that your
                Personal Information will be transferred and processed on our
                facilities and servers in the United States, and potentially
                other countries as we expand our business, according to the laws
                and regulations of the USA.
              </li>
            </ol>
          </div>
        </div>
