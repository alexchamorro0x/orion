      ...
      <section className="container flex text-slate-300 mx-auto">
        <div className="legal">
          ...
          <div className="blog-post-text">
            <p>
              Orion Digital Consulting, Inc. (“Orion,” “we,” “us,” “our”)
              ...
              applications, and the Site, the “Service” or “Services”), subject
              to the following Terms of Service (as amended from time to time,
              the “Terms of Service”). We reserve the right, at our sole
              discretion, to change or modify portions of these Terms of Service
              ...
              were last revised. We will also notify you, either through the
              Service user interface, in an email notification or through other
              reasonable means. Any such changes will become effective no
              earlier than fourteen (14) days after they are posted, except that
              changes addressing new functions of the Service or changes made
            ...
            <p>
              <strong>
                <em>
                  ...
                  PURSUE CLAIMS AGAINST Orion Digital Consulting ON AN
                  INDIVIDUAL BASIS, NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY
                  CLASS OR REPRESENTATIVE ACTION OR PROCEEDING, (2) YOU WILL
                  ONLY BE PERMITTED TO SEEK RELIEF (INCLUDING MONETARY,
                  INJUNCTIVE, AND DECLARATORY RELIEF) ON AN INDIVIDUAL BASIS,
                  AND (3) YOU MAY NOT BE ABLE TO HAVE ANY CLAIMS YOU HAVE
            ...
            <p>
              ...
              limitation, the{" "}
              <Link href="/privacy" onClick={ResetLocation}>
                <strong>
          ...
          <Heading as="h2">Access and Use of the Service</Heading>
          <div className="blog-post-text">
            <p>
              <strong>Services Description:</strong> The Service is designed to
              provide an audio, video and text-based social networking platform.
              The Service allows users to create and monetize audio, video and
              text content that are generally available to all other users.
            </p>
            <p>
              <strong>Recording by Orion Digital Consulting:</strong> Orion
              Digital Consulting records and saves all audio, video and text
              uploaded to the Service. Orion Digital Consulting does this in
              order to improve its products and services, provide you with
              recommendations, and to ensure the security and integrity of its
              platform. If you are not comfortable with Orion Digital Consulting
              recording your contributions, please do not contribute to the
              site.
            </p>
            <p>
              <strong>Media Export Requirements:</strong> Orion Digital
              Consulting may make certain uploaded content available for export
              to broadcasters and other authorized third parties. With respect
              to any audio and/or video streams exported from the Service, you
              agree to provide public attribution to Orion Digital Consulting
              when you share any content first created within the Service.
            </p>
            <p>
              <strong>Right to Participate:</strong> If you plan to
              commercialize any audio and/or video content, NFTs or other works
              you first create using the Service (“Creator Works”) with a third
              party or otherwise outside of the Service, you agree to use
              commercially reasonable efforts to first notify Orion Digital
              Consulting by email.
            </p>
            <p>
              <strong>Your Registration Obligations:</strong> You may be
              required to register with Orion Digital Consulting in order to
              ...
              prompted by the Service&apos;s registration form. Registration
              data and certain other information about you are governed by our
              Privacy Policy. If you are under 16 years of age, you are not
              authorized to use the Service, with or without registering. In
              addition, if you are under 18 years old, you may use the Service,
              with or without registering, only with the approval of your parent
              or guardian.
            </p>
            <p>
              ...
              (a) immediately notify Orion Digital Consulting of any
              ...
              end of each session when accessing the Service. Orion Digital
              Consulting will not be liable for any loss or damage arising from
              your failure to comply with this Section.
            </p>
            <p>
              <strong>Modifications to Service:</strong> Orion Digital
              Consulting reserves the right to modify or discontinue,
              temporarily or permanently, the Service (or any part thereof) with
              or without notice. You agree that Orion Digital Consulting will
            ...
            <p>
              ...
              acknowledge that Orion Digital Consulting may establish general
              ...
              space that will be allotted on Orion Digital Consulting on your
              behalf. You agree that Orion Digital Consulting has no
              ...
              You acknowledge that Orion Digital Consulting reserves the right
              to terminate accounts that are inactive for an extended period of
              time. You further acknowledge that Orion Digital Consulting
              reserves the right to change these general practices and limits at
              any time, in its sole discretion, with or without notice.
            </p>
            <p>
              <strong>Mobile Services:</strong> The Service includes certain
              services that are available via a mobile device, including (i) the
              ability to upload content to the Service via a mobile device, (ii)
              the ability to browse the Service and the Site from a mobile
              device and (iii) the ability to access certain features through an
              ...
              with you regarding Orion Digital Consulting and other entities by
              ...
              update your Orion Digital Consulting account information to ensure
              that your messages are not sent to the person that acquires your
              old number.
            </p>
          </div>
          <Heading as="h2">Conditions of Use</Heading>
          <div className="blog-post-text">
            <p>
              <strong>User Conduct:</strong> You are solely responsible for all
              video, images, information, data, text, music, sound, photographs,
              ...
              kind of content and/or use that is illegal or prohibited by Orion
              Digital Consulting. Orion Digital Consulting reserves the right to
              investigate and take appropriate legal action against anyone who,
              in Orion Digital Consulting&apos;s sole discretion, violates this
            ...
            <div>
              <ol className="ml-8 list-outside list-decimal mb-4">
                <li>
                  ...
                  objectionable; or (vii) in the sole judgment of Orion Digital
                  Consulting, is objectionable or which restricts or inhibits
                  any other person from using or enjoying the Service, or which
                  may expose Orion Digital Consulting or its users to any harm
          ...
          <Heading as="h2">Third Party Distribution Channels</Heading>
          <div className="blog-post-text">
            <p>
              Orion Digital Consulting offers Software applications that may be
              made available through the Apple App Store, the Google Play Store
              or other distribution channels (“Distribution Channels”). If you
              obtain such Software through a Distribution Channel, you may be
              ...
              our Services, you agree to comply with all applicable terms of any
            ...
            <div>
              <ul className="ml-8 list-outside list-disc mb-4">
                <li>
                  ...
                  you only, and not with Apple Inc. (“Apple”), and that as
                  between Orion Digital Consulting and Apple, Orion Digital
                  Consulting, not Apple, is solely responsible for the
                ...
                <li>
                  ...
                  failure to conform to any warranty, which will be Orion
                  Digital Consulting&apos;s sole responsibility, to the extent
                  it cannot be disclaimed under applicable law.
                </li>
                <li>
                  Orion Digital Consulting and you acknowledge that Orion
                  Digital Consulting, not Apple, is responsible for addressing
                ...
                <li>
                  ...
                  intellectual property rights, as between Orion Digital
                  Consulting and Apple, Orion Digital Consulting, not Apple,
            ...
            <p>
              Orion Digital Consulting and you acknowledge and agree that Apple,
              and Apple&apos;s subsidiaries, are third party beneficiaries of
              these Terms of Service with respect to the Apple-Enabled Software,
              ...
              Service against you with respect to the Apple-Enabled Software as
          ...
          <div className="blog-post-text">
            <p>
              ...
              acknowledge and agree that the Service may contain content or
              features (“Service Content”) that are protected by copyright,
              patent, trademark, trade secret or other proprietary rights and
              laws. Except as expressly authorized by Orion Digital Consulting,
              ...
              below) that you legally upload to the Service. In connection with
              your use of the Service you will not engage in or use any data
              mining, robots, scraping or similar data gathering or extraction
              methods. If you are blocked by Orion Digital Consulting from
              ...
              connection therewith are the property of Orion Digital Consulting,
              our affiliates and our partners (the “Software”). You agree not to
            ...
            <p>
              Orion Digital Consulting, product, and service names and logos
              ...
              affiliated with or connected to Orion Digital Consulting. Nothing
              in this Terms of Service or the Service should be construed as
              granting, by implication, estoppel, or otherwise, any license or
              right to use any of Orion Digital Consulting Trademarks displayed
              on the Service, without our prior written permission in each
              instance. All goodwill generated from the use of Orion Digital
              Consulting Trademarks will inure to our exclusive benefit.
            </p>
            <p>
              <strong>Third Party Material:</strong> Under no circumstances will
              Orion Digital Consulting be liable in any way for any content or
              materials of any third parties (including users), including, but
              ...
              any such content. You acknowledge that Orion Digital Consulting
              does not pre-screen content, but that Orion Digital Consulting and
              its designees will have the right (but not the obligation) in
              their sole discretion to refuse or remove any content that is
              available via the Service. Without limiting the foregoing, Orion
              Digital Consulting and its designees will have the right to remove
              any content that violates these Terms of Service or is deemed by
              Orion Digital Consulting, in its sole discretion, to be otherwise
            ...
            <p>
              ...
              With respect to the content, audio, video or other materials you
              upload through the Service or share with other users or recipients
              ...
              rights of publicity contained therein. By uploading or creating
              any User Content you hereby grant and will grant Orion Digital
              Consulting and its affiliated companies a nonexclusive, worldwide,
              royalty free, fully paid up, transferable, sub-licensable,
              perpetual, irrevocable license to copy, display, upload, perform,
              distribute, store, modify, create derivative works of and
              otherwise use your User Content in connection with the operation
              of the Service or the promotion, advertising or marketing thereof
              in any form, medium or technology now known or later developed.
              You expressly represent and warrant that your User Content
              contains only original content otherwise authorized for use by
              you, and do not contain unlicensed or unauthorized copyrighted
              content, including any imagery, design, audio, video, human
              likeness, or other unoriginal content not created by you, not
              authorized for use by you, not in the public domain, or otherwise
              without a valid claim of fair use. You further represent and
              warrant that you have permission to incorporate the unoriginal
              content.
            </p>
            <p>
              You acknowledge and agree that any questions, comments,
              suggestions, ideas, feedback or other information about or in
              connection with the Service (“Submissions”), provided by you to
              Orion Digital Consulting are non-confidential and Orion Digital
              Consulting will be entitled to the unrestricted use and
              dissemination of these Submissions for any purpose, commercial or
              otherwise, without acknowledgment or compensation to you.
            </p>
            <p>
              You acknowledge and agree that Orion Digital Consulting may
              ...
              or personal safety of Orion Digital Consulting, its users and the
            ...
            <p>
              Copyright Complaints: Orion Digital Consulting respects the
              ...
              property rights have been otherwise violated, you should notify
              Orion Digital Consulting of your infringement claim in accordance
            ...
            <div>
              <p>
                <strong>Counter-Notice:</strong> If you believe your User
                Content that was removed (or to which access was disabled) is
                not infringing, or that you have the authorization from the
                copyright owner, the copyright owner&apos;s agent, or pursuant
                to the law, to upload and use the content in your User Content,
            ...
            <p>
              If a counter-notice is received by the Copyright Agent, Orion
              Digital Consulting will send a copy of the counter-notice to the
            ...
            <p>
              ...
              DMCA and other applicable law, Orion Digital Consulting has
              adopted a policy of terminating, in appropriate circumstances and
              at Orion Digital Consulting&apos;s sole discretion, users who are
              deemed to be repeat infringers. Orion Digital Consulting may also
          ...
          <Heading as="h2">Third Party Websites</Heading>
          <div className="blog-post-text">
            <p>
              The Service may provide, or third parties may provide, links or
              other access to other sites and resources on the Internet. Orion
              Digital Consulting has no control over such sites and resources
              and Orion Digital Consulting is not responsible for and does not
              endorse such sites and resources. You further acknowledge and
              agree that Orion Digital Consulting will not be responsible or
              ...
              any such site or resource. Any dealings you have with third
              parties found while using the Service are between you and the
              third party, and you agree that Orion Digital Consulting is not
              liable for any loss or claim that you may have against any such
              third party.
            </p>
          </div>
          <Heading as="h2">Social Networking Services</Heading>
          <div className="blog-post-text">
            <p>
              ...
              accordance with our Privacy Policy. For more information about the
              implications of activating these Social Networking Services and
              Orion Digital Consulting&apos;s use, storage and disclosure of
              ...
              Digital Consulting shall have no liability or responsibility for
              the privacy practices or other actions of any third party site or
              service that may be enabled within the Service.
            </p>
            <p>
              In addition, Orion Digital Consulting is not responsible for the
              accuracy, availability or reliability of any information, content,
              goods, data, opinions, advice or statements made available in
              connection with Social Networking Services. As such, Orion Digital
              Consulting is not liable for any damage or loss caused or alleged
              to be caused by or in connection with use of or reliance on any
              such Social Networking Services. Orion Digital Consulting enables
              these features merely as a convenience and the integration or
              inclusion of such features does not imply an endorsement or
              recommendation.
            </p>
          </div>
          <Heading as="h2">General Media Release</Heading>
          <div className="blog-post-text">
            <p>
              Please note that Orion Digital Consulting is obtaining this
              General Media Release in order to protect its creators and allow
              them to freely use, reproduce, distribute and license the content
              they create on Orion Digital Consulting off of the application
              without having to obtain media releases from each Orion Digital
              Consulting member they may have interacted with in creating their
              content (for example but not limited to Alternatives, Reviews and
              other Orion Digital Consultinges). Please keep in mind that any
              reference to &quot;Associated Parties&quot; (as defined below)
              includes creators.
            </p>
            <p>
              Through this release, you hereby authorize Orion Digital
              Consulting and its licensees, directors, officers, employees,
              contractors, representatives, successors, assigns and any
              authorized users of the Service (collectively, the
              &quot;Associated Parties&quot;) to create audio and/or video
              recordings, still and digital images and/or textual descriptions,
              testimonials, and statements made by you through the Orion Digital
              Consulting application (hereinafter, the &quot;Recordings&quot;),
              without further compensation or permission.
            </p>
            <p>
              You hereby agree and acknowledge that Orion Digital Consulting and
              any Associated Parties (e.g., creators) may use the Recordings,
              including your name and likeness, for any commercial and
              non-commercial purposes (including the creation of NFTs),
              including to use, reproduce, distribute, and license to others in
              accordance with Orion Digital Consulting&apos;s Terms of Service,
              in any manner of media whatsoever now or hereafter known, without
              further compensation or permissions.
            </p>
            <p>
              You understand that all Recordings in which you participate are
              the exclusive property of Orion Digital Consulting or an
              Associated Party (e.g., a creator) and you waive any right to
              inspect or approve of the final images or content in which the
              Recordings appear.
            </p>
            <p>
              You hereby irrevocably agree that you will not assert or maintain
              against Orion Digital Consulting or the Associated Parties any
              claim, action, suit or demand of any kind or nature through their
              use, distribution and exploitation of the Recordings.
            </p>
          </div>
          <Heading as="h2">Indemnity and Release</Heading>
          <div className="blog-post-text">
            <p>
              You agree to release, indemnify and hold Orion Digital Consulting
              and its affiliates and their officers, employees, directors and
              agents (collectively, “Indemnitees”) harmless from any from any
              and all losses, damages, expenses, including reasonable
              attorneys&apos; fees, rights, claims, actions of any kind and
              injury (including death) arising out of or relating to your use of
              the Service, any User Content, your connection to the Service,
              ...
              obligation to indemnify or hold harmless any Indemnitee from or
              against any liability, losses, damages or expenses incurred as a
              result of any action or inaction of such Indemnitee. If you are a
          ...
          <div className="blog-post-text">
            <p>
              ...
              PROVIDED ON AN “AS IS” AND “AS AVAILABLE” BASIS. Orion Digital
              Consulting EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER
              EXPRESS, IMPLIED OR STATUTORY, INCLUDING, BUT NOT LIMITED TO THE
              IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
              PURPOSE, TITLE AND NON-INFRINGEMENT.
            </p>
            <p>
              Orion Digital Consulting MAKES NO WARRANTY THAT (I) THE SERVICE
          ...
          <div className="blog-post-text">
            <p>
              YOU EXPRESSLY UNDERSTAND AND AGREE THAT Orion Digital Consulting
              ...
              DATA OR OTHER INTANGIBLE LOSSES (EVEN IF Orion Digital Consulting
              ...
              RELATING TO THE SERVICE. IN NO EVENT WILL Orion Digital
              Consulting&apos;S TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES
              OR CAUSES OF ACTION EXCEED THE AMOUNT YOU HAVE PAID Orion Digital
              Consulting IN THE LAST SIX (6) MONTHS, OR, IF GREATER, ONE HUNDRED
              DOLLARS ($100).
            </p>
            <p>
            ...
            <div>
              ...
              <p className="bold-text">a. Agreement to Arbitrate</p>
              <p>
                ...
                have arisen or may arise between you and Orion Digital
                Consulting, whether arising out of or relating to this Terms of
                Service (including any alleged breach thereof), the Services,
                any advertising, any aspect of the relationship or transactions
                between us, shall be resolved exclusively through final and
                binding arbitration, rather than a court, in accordance with the
                ...
                Terms of Service, you and Orion Digital Consulting are each
              ...
              <p>
                <strong>
                  <em>
                    YOU AND Orion Digital Consulting AGREE THAT EACH OF US MAY
                    BRING CLAIMS AGAINST THE OTHER ONLY ON AN INDIVIDUAL BASIS
                    AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED
                    CLASS OR REPRESENTATIVE ACTION OR PROCEEDING. UNLESS BOTH
                    YOU AND Orion Digital Consulting AGREE OTHERWISE, THE
                    ARBITRATOR MAY NOT CONSOLIDATE OR JOIN MORE THAN ONE
                    ...
                    BY THAT PARTY&apos;S INDIVIDUAL CLAIM(S), EXCEPT THAT YOU
                    MAY PURSUE A CLAIM FOR AND THE ARBITRATOR MAY AWARD PUBLIC
                    INJUNCTIVE RELIEF UNDER APPLICABLE LAW TO THE EXTENT
                    REQUIRED FOR THE ENFORCEABILITY OF THIS PROVISION.
                  </em>
                </strong>
              </p>
              <p className="bold-text">c. Pre-Arbitration Dispute Resolution</p>
              <p>
                Orion Digital Consulting is always interested in resolving
                disputes amicably and efficiently, and most customer concerns
                can be resolved quickly and to the customer&apos;s satisfaction
                by emailing customer support. If such efforts prove
                unsuccessful, a party who intends to seek arbitration must first
                send to the other, by certified mail, a written Notice of
                Dispute (“Notice”). The Notice must (i) describe the nature and
                basis of the claim or dispute and (ii) set forth the specific
                relief sought. If Orion Digital Consulting and you do not
                resolve the claim within sixty (60) calendar days after the
                Notice is received, you or Orion Digital Consulting may commence
                an arbitration proceeding. During the arbitration, the amount of
                any settlement offer made by Orion Digital Consulting or you
                shall not be disclosed to the arbitrator until after the
                arbitrator determines the amount, if any, to which you or Orion
                Digital Consulting is entitled.
              </p>
              <p className="bold-text">d. Arbitration Procedures</p>
              <p>
              ...
              <p>
                Unless Orion Digital Consulting and you agree otherwise, any
                arbitration hearings will take place in a reasonably convenient
                location for both parties with due consideration of their
                ability to travel and other pertinent circumstances. If the
                parties are unable to agree on a location, the determination
                shall be made by AAA. If your claim is for $10,000 or less,
                Orion Digital Consulting agrees that you may choose whether the
              ...
              <p className="bold-text">e. Costs of Arbitration</p>
              <p>
                ...
                at your request, Orion Digital Consulting will pay all
                Arbitration Fees. If the value of relief sought is more than
                $75,000 and you are able to demonstrate to the arbitrator that
                you are economically unable to pay your portion of the
                Arbitration Fees or if the arbitrator otherwise determines for
                any reason that you should not be required to pay your portion
                of the Arbitration Fees, Orion Digital Consulting will pay your
                ...
                compared to the costs of litigation, Orion Digital Consulting
              ...
              <p>
                ...
                then the entirety of this Arbitration Agreement shall be null
                and void, unless such provisions are deemed to be invalid or
              ...
              <p>
                ...
                contrary, Orion Digital Consulting agrees that if it makes any
                future change to this Arbitration Agreement (other than a change
                to the Notice Address) while you are a user of the Services, you
                may reject any such change by sending Orion Digital Consulting
                written notice within thirty (30) calendar days of the change to
                the Notice Address provided above. By rejecting any future
                ...
                Agreement as of the date you first accepted these Terms of
          ...
          <div className="blog-post-text">
            <p>
              You agree that Orion Digital Consulting, in its sole discretion,
              may suspend or terminate your account (or any part thereof) or use
              of the Service and remove and discard any content within the
              Service, for any reason, including, without limitation, for lack
              of use or if Orion Digital Consulting believes that you have
              ...
              of Service, may be referred to appropriate law enforcement
              authorities. Orion Digital Consulting may also in its sole
              ...
              acknowledge and agree that Orion Digital Consulting may
              ...
              access to such files or the Service. Further, you agree that Orion
              Digital Consulting will not be liable to you or any third party
              for any termination of your access to the Service.
            </p>
          </div>
          <Heading as="h2">User Disputes</Heading>
          <div className="blog-post-text">
            <p>
              You agree that you are solely responsible for your interactions
              with any other user in connection with the Service and Orion
              Digital Consulting will have no liability or responsibility with
              respect thereto. Orion Digital Consulting reserves the right, but
              has no obligation, to become involved in any way with disputes
          ...
          <div className="blog-post-text">
            <p>
              ...
              and Orion Digital Consulting and govern your use of the Service,
              superseding any prior agreements between you and Orion Digital
              Consulting with respect to the Service. You also may be subject to
              ...
              law provisions. With respect to any disputes or claims not subject
              to arbitration, as set forth above, you and Orion Digital
              Consulting agree to submit to the personal and exclusive
              jurisdiction of the state and federal courts located within San
              Francisco County, California. The failure of Orion Digital
              Consulting to exercise or enforce any right or provision of these
              ...
              the other provisions of these Terms of Service remain in full
              force and effect. You agree that regardless of any statute or law
              to the contrary, any claim or cause of action arising out of or
              related to use of the Service or these Terms of Service must be
              ...
              Terms of Service without the prior written consent of Orion
              Digital Consulting, but Orion Digital Consulting may assign or
              ...
              convenience only and have no legal or contractual effect. Notices
              to you may be made via either email or regular mail. The Service
              may also provide notices to you of changes to these Terms of
              Service or other matters by displaying notices or links to notices
              generally on the Service.
            </p>
          </div>
          <Heading as="h2">Your Privacy</Heading>
          <div className="blog-post-text">
            <p>
