...
export default function AboutTwo() {
  ...
  return (
    <article className="py-16 lg:py-36 px-4 sm:px-6 lg:px-8">
      <section className="relative max-w-max lg:max-w-7xl mx-auto">
        <svg
          className="hidden lg:block absolute top-0 right-0 -mt-20"
          width={404}
          height={384}
          fill="none"
          viewBox="0 0 404 384"
        ...
        <svg
          className="hidden lg:block absolute bottom-0 left-0 -mb-20"
          width={404}
          height={384}
          fill="none"
          viewBox="0 0 404 384"
        ...
        <section className="relative z-10 bg-slate-900 lg:mx-20 lg:px-6">
          <section className="mb-8 lg:mb-2 text-base lg:max-w-none ">
          ...
          <section className="lg:grid lg:grid-cols-2 lg:gap-6">
            <section className="text-slate-400 lg:max-w-none">
            ...
            <section className="mt-6 text-slate-400 lg:mt-0">
              <p className="text-xl font-semibold text-sky-400 my-2">
