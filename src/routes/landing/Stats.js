...
export default function Stats() {
  return (
    <article className="relative bg-slate-900">
      <section className="h-64 w-full absolute bottom-0 xl:inset-0 xl:h-full">
        <section className="h-full w-full xl:grid xl:grid-cols-2">
          <section className="h-full xl:relative xl:col-start-2">
            ...
            <section
              aria-hidden="true"
              className="absolute inset-x-0 top-0 h-64 w-full bg-gradient-to-b from-slate-900 to-slate-500/20 xl:inset-y-0 xl:left-0 xl:h-full xl:bg-gradient-to-r"
            />
          </section>
        </section>
      </section>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
        <section className="relative pt-12 pb-64 xl:col-start-1 xl:pb-24">
