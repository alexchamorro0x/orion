        ...
        <div className="legal">
          ...
          <div className="blog-post-text">
            ...
            <p>
              ...
              Policy. If you are under 16 years of age, you are not authorized
              to use the Service, with or without registering. In addition, if
            ...
            <p>
              ...
              all Mobile Services may work with all carriers or devices. By
              using the Mobile Services, you agree that we may communicate with
              you regarding Orion Digital Consulting and other entities by SMS,
              MMS, text message or other electronic means to your mobile device
              and that certain information about your usage of the Mobile
          ...
          <div className="blog-post-text">
            ...
            <div>
              <ul className="ml-8 list-outside list-disc mb-4">
                ...
                <li>
                  ...
                  Digital Consulting’s sole responsibility, to the extent it
            ...
            <p>
              ...
              Terms of Service, Apple will have the right (and will be deemed to
              have accepted the right) to enforce these Terms of Service against
              you with respect to the Apple-Enabled Software as a third party
              beneficiary thereof.
            </p>
          </div>
          ...
          <div className="blog-post-text">
            ...
            <div>
              <p>
                ...
                law, to upload and use the content in your User Content, you may
          ...
          <div className="blog-post-text">
            <p>
              ...
              reference to "Associated Parties" (as defined below) includes
              creators.
            </p>
            <p>
              ...
              authorized users of the Service (collectively, the "Associated
              Parties") to create audio and/or video recordings, still and
              digital images and/or textual descriptions, testimonials, and
              statements made by you through the Orion Digital Consulting
              application (hereinafter, the "Recordings"), without further
            ...
            <p>
              ...
              accordance with Orion Digital Consulting's Terms of Service, in
              any manner of media whatsoever now or hereafter known, without
          ...
          <div className="blog-post-text">
            <p>
              ...
              Consulting’S TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES OR
              CAUSES OF ACTION EXCEED THE AMOUNT YOU HAVE PAID Orion Digital
            ...
            <div>
              ...
              <p>
                <strong>
                  <em>
                    ...
                    MONETARY, INJUNCTIVE, AND DECLARATORY RELIEF) ONLY IN FAVOR
                    OF THE INDIVIDUAL PARTY SEEKING RELIEF AND ONLY TO THE
                    EXTENT NECESSARY TO PROVIDE RELIEF NECESSITATED BY THAT
              ...
              <p>
                ...
                can be resolved quickly and to the customer’s satisfaction by
                emailing customer support. If such efforts prove unsuccessful, a
                party who intends to seek arbitration must first send to the
                other, by certified mail, a written Notice of Dispute
                (“Notice”). The Notice must (i) describe the nature and basis of
                the claim or dispute and (ii) set forth the specific relief
                sought. If Orion Digital Consulting and you do not resolve the
                claim within sixty (60) calendar days after the Notice is
                received, you or Orion Digital Consulting may commence an
          ...
          <div className="blog-post-text">
            <p>
              ...
              Service without the prior written consent of Orion Digital
              Consulting, but Orion Digital Consulting may assign or transfer
              this Terms of Service, in whole or in part, without restriction.
              ...
              other matters by displaying notices or links to notices generally
              on the Service.
            </p>
          </div>
